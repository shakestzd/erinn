...
```
/wipnote:error-analysis [error_context]
```
...
5. **Provide systematic investigation prompts:**
   ...
   **Hook Errors:**
   - [ ] Research hook documentation (use /wipnote:research or claude-code-guide)
...
6. **Dispatch codebase investigation:**
   ...
   Use `Task(subagent_type="wipnote:researcher")` for systematic error investigation.
...
```
1. /wipnote:error-analysis "error message"  → Capture & categorize
2. [Complete investigation checklist]          → Gather evidence
3. /wipnote:research "topic" (if needed)    → Research unfamiliar concepts
...
/wipnote:research "Claude Code hook loading and file paths"
...
✅ **Correct approach:**
1. Use `/wipnote:error-analysis` to capture error
2. Use `/wipnote:research` to understand root cause
