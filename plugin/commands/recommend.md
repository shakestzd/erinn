...
This command invokes `wipnote recommend` via the CLI, which provides all analytics in one unified output.

**Key workflow:**
1. Run `wipnote recommend [--top N]` where N is user's choice or default 5
