...
// Codex session-start payload — representative captured payload shape.
const codexSessionStartJSON = `{
	"session_id": "019da445-8036-73c2-a8fc-dacdb57417a8",
	"transcript_path": "/mock/.codex/sessions/2026/04/19/rollout-2026-04-19T01-45-11-019da445-8036-73c2-a8fc-dacdb57417a8.jsonl",
	"cwd": "/mock/DevProjects/htmlgraph",
...
const claudeSessionStartJSON = `{
	...
	"transcript_path": "/mock/session.jsonl",
	"source": "startup"
}`
...
func TestParseCodexSessionStart(t *testing.T) {
	...
	if ev.CWD != "/mock/DevProjects/htmlgraph" {
		t.Errorf("CWD = %q, want /mock/DevProjects/htmlgraph", ev.CWD)
	}
	if ev.Model != "gpt-5.4" {
